                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-4 rounded-xl bg-primary/5 border border-primary/20 space-y-3">
                        <p className="text-base font-semibold text-foreground leading-relaxed">
                          Upload all assessments, questionnaires, exercises, quizzes, and reflection assignments to create a more complete picture of your transformation journey and the framework guiding it. Including these materials in the roadmap/framework assessment provides valuable context about your current strengths, needs, progress, and areas for growth. It also helps identify patterns, clarify priorities, and ensure that the roadmap is personalized, actionable, and aligned with your goals.
                        </p>
