  ...
  return (
    <section className="relative flex items-center pt-24 pb-12 lg:pt-32 lg:pb-0 overflow-hidden min-h-[90vh]">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Target Image as Background Layer */}
        <div className="absolute inset-0 flex items-center justify-center opacity-50 pointer-events-none">
          <img 
            src={targetImage} 
            alt="" 
            className="w-full h-full object-contain scale-125 lg:scale-100"
          />
        </div>
      </div>

      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col gap-8 text-left max-w-3xl mx-auto lg:mx-0">
          <div>
            <motion.div
