    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Help unfulfilled professionals, college students, recent graduates, retirees, and veterans find their life purpose through guided journaling, Transformation Analysis, and actionable skill mapping.
          </motion.p>
