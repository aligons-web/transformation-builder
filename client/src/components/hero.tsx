      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center gap-12 justify-center text-center">
          <div className="max-w-4xl mx-auto">
            ...
            >
              Start Your Journey Today with <span className="text-primary italic font-serif">Perspective</span><span className="text-primary">,</span> <span className="text-primary italic font-serif">Purpose</span><span className="text-primary">,</span> and <span className="text-primary italic font-serif">Passion</span><span className="text-primary">!</span>
            </motion.h2>
