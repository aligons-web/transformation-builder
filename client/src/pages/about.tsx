...
import { ArrowLeft, BookOpen, Compass, Sparkles, Quote, Plus } from "lucide-react";
  ...
  const testimonials = [
    {
      ...
      image: stock1,
      text: "I was completely lost after graduation. The Discover Purpose module helped me connect the dots between my passions and a real career path. I finally have clarity!"
    },
    {
      id: 2,
      name: "Marcus Thorne",
      ...
      image: stock2,
      text: "Transitioning to civilian life was harder than I expected. This workbook gave me the structure I needed to redefine my mission and find a new sense of purpose."
    },
    {
      id: 3,
      ...
      role: "Entrepreneur",
      image: stock3,
      text: "I had the business skills but lacked the 'why'. The deep analysis in Step 2 revealed patterns I'd never noticed. It completely shifted my business strategy."
    },
    {
      id: 4,
      name: "David Chen",
      ...
      image: stock4,
      text: "I felt stuck in a corporate job that didn't fulfill me. The 'Actionable Focus' step gave me a concrete plan to pivot without losing everything I've built."
    }
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-4 space-y-6 sticky top-8">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-heading font-bold text-xl text-foreground">Success Stories</h3>
                ...
                <Link href="/submit-testimonial">
                  <Button variant="outline" className="w-full border-dashed border-primary/30 text-primary hover:bg-primary/5 hover:border-primary/50 h-auto py-4 flex flex-col gap-2">
                    <Plus className="w-5 h-5" />
                    <span>Submit Your Story</span>
                    <span className="text-xs font-normal text-muted-foreground">Join our community of transformers</span>
                  </Button>
                </Link>
              </div>
            </div>
