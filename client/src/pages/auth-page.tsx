...
import authBg from "@assets/tbuildercover_1781107803431.png";
    ...
    try {
      if (activeTab === "signup") {
        ...
        toast({
          ...
          description: `Welcome ${values.username}! Your account has been created successfully.`,
        });
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 text-sm">
                    <p className="font-medium text-primary mb-1">🎁 Access 3 Modules Free!</p>
                    <p className="text-muted-foreground text-xs">
                    Access 3 modules free. No credit card needed. Get full access to Explorer and Transformer features by upgrading. 
                  ...
                  <Button type="submit" className="w-full h-11 text-base" disabled={isLoading}>
                    {isLoading ? (
                      ...
                      <>
                                              Create Account & Access 3 Free Modules! 
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </>
                    )}
                  </Button>
