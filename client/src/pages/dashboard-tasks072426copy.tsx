...
export default function DashboardTasksPage() {
  ...
  // Start with empty state - users add their own tasks and goals
  ...
  const completedGoals = events.filter(e => e.type === "goal" && e.completed).length;
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {totalTasks > 0 ? `${completedTasks}/${totalTasks}` : "No tasks yet"}
                </div>
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {totalGoals > 0 ? `${completedGoals}/${totalGoals}` : "No goals yet"}
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  {totalGoals > 0 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            {dayEvents.map((event) => (
                              <div 
                                ...
                                className={cn(
                                  ...
                                  event.type === "task" && !event.completed && "bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100",
                                  event.type === "task" && event.completed && "bg-blue-50/50 text-blue-400 border-blue-100 line-through",
                                  event.type === "goal" && !event.completed && "bg-orange-50 text-orange-700 border-orange-200 hover:bg-orange-100",
                                  event.type === "goal" && event.completed && "bg-orange-50/50 text-orange-400 border-orange-100 line-through"
                                )}
            ...
            <div className="space-y-8">
              <Card>
                ...
                <CardContent>
                  {events.filter(e => !e.completed && e.date >= new Date()).length > 0 ? (
                    <div className="space-y-4">
                      {events
                        ...
                        .map((event) => (
                          <div 
                            key={event.id} 
                            className="flex items-center gap-4 p-3 rounded-lg hover:bg-muted/50 transition-colors border border-transparent hover:border-border/50 cursor-pointer"
                            onClick={() => toggleEventComplete(event.id)}
                          >
                            <div className={cn(
                              "w-5 h-5 rounded-full border-2",
                              event.type === "task" ? "border-blue-400" : "border-orange-400"
                            )} />
                            ...
                            <span className={cn(
                              ...
                              event.type === "task" ? "bg-blue-100 text-blue-700" : "bg-orange-100 text-orange-700"
                            )}>
                    ...
                    <div className="text-center py-8">
                      <p className="text-muted-foreground text-sm mb-4">No upcoming tasks or goals</p>
