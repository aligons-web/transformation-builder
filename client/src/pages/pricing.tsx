          ...
          <Card className="flex flex-col border-border/50 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent className="flex-1">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-green-500" />
                  <span className="text-sm">2 Accountability Zoom Sessions per Month<br />Includes: 1 Skill Development Session and 1 Business Development Session (1 hour each)</span>
                </li>
              </ul>
            </CardContent>
            <CardFooter>
